...
/**
 * The shelf — compact gallery cards at the bottom of the Work page.
...
export const projects = [
  ...
  },
  {
    ...
    dates: "2023",
    blurb:
      "Forecasts pavement deterioration across 40k+ segments — 0.065 RMSE on next-year roughness.",
  ...
  },
  {
    id: "tremor-band",
    category: "devices",
    title: "Tremor-Damping Wristband",
    dates: "Ongoing",
    blurb:
      "Haptic wristband that damps my dad's tremor — firmware, sensing, and a printed enclosure.",
    tags: ["Embedded", "Haptics"],
    links: [],
  },
  {
    id: "ncaa-basketball",
  ...
  },
  {
    ...
    dates: "2025",
    blurb:
      "Kalman-filtered intraday beta pipeline for portfolio risk — details stay with the Investment Committee.",
  ...
  },
  {
    ...
    title: "NFL Analytics",
    status: "In progress",
    blurb: "An analytics toolkit for NFL game and player data, currently being written.",
