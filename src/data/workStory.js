 ...
 * Cards: { name, logo?, meta?, tech?, blurb, link?, photo? } — omit logo to
 * render an initial-letter tile instead. `photo` ({ src?, alt, caption,
 * placeholderLabel }) is the polaroid that reveals on hover.
 * In paragraphs, wrap phrases in **double asterisks** for weighted emphasis.
 */
  ...
  chapters: [
    ...
    },
    {
      ...
      card: {
        ...
        photo: { caption: "policy nlp", placeholderLabel: "research desk" },
      },
    },
    {
      id: "sparksoft",
      ...
      card: {
        ...
        photo: { caption: "cms portal", placeholderLabel: "the portal" },
      },
    },
    {
      id: "amazon",
      ...
      card: {
        ...
        photo: { caption: "cert portal", placeholderLabel: "tempe summer" },
      },
    },
    {
      ...
      card: {
        ...
        photo: { caption: "seller recs", placeholderLabel: "recommendations" },
      },
    },
    {
      id: "scheller",
      ...
      card: {
        ...
        photo: { caption: "market edge", placeholderLabel: "prediction board" },
      },
    },
    {
      id: "closing",
