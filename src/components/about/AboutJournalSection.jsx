...
function SectionHeader({ section }) {
  return (
    <header className="journal-section__header">
      <p className="journal-section__number">{section.number}</p>
      <h2 className="journal-section__title">{section.title}</h2>
      <p className="journal-section__kicker">{section.kicker}</p>
    </header>
  );
}
